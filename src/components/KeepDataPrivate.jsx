		...
		<section className="mt-32">
			<div className="my-container">
				<div className="grid grid-cols-2 gap-x-3 ">
					...
					<div className="tPro:order-1 order-2 tPro:col-span-1 col-span-2 flex flex-col items-center content my-auto justify-start lpro:px-10 tPro:mt-12 mt-10 mx-10">
						<h2 className="w-full">
							Keep your Data
