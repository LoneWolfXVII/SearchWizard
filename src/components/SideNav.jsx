  ...
  return (
    ...
    >
      <div className="grow">
        ...
        <div>
          <Link to={"/app/new-chat"} className={`flex gap-4 items-center cursor-pointer text-primary80 text-sm font-medium ${isSideNavOpen ? "rounded-[200px]" : "rounded-full pr-6"} px-5 py-3 mt-10 mb-8 bg-purple-4`}>
            <div>+</div>
